...
describe("Treasury.spec", async () => {
  ...
  context("auth", async () => {
    ...
    it("should initialize correctly", async () => {
      ...
      expect(await treasury.fToken()).to.eq(fTokenAddress);
      expect(await treasury.xToken()).to.eq(xTokenAddress);
      expect(await treasury.baseToken()).to.eq(wethAddress);
      expect(await treasury.priceOracle()).to.eq(oracleAddress);
