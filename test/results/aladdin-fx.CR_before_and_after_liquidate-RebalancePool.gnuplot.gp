set title "CR_before_and_after_liquidate-RebalancePool" noenhanced
datafile = "aladdin-fx.CR_before_and_after_liquidate-RebalancePool.gnuplot.csv"
# additional imformation and error in aladdin-fx.CR_before_and_after_liquidate-RebalancePool.error.csv
set datafile separator comma
set key autotitle columnheader noenhanced
set key bmargin
set key title " "
# set terminal pngcairo
# set output "aladdin-fx.CR_before_and_after_liquidate-RebalancePool.gnuplot.png"
set terminal svg enhanced size 800 566.5 background rgb "gray90"
set autoscale
set colorsequence default
# set output "aladdin-fx.CR_before_and_after_liquidate-RebalancePool.gnuplot.svg"
set xrange reverse
