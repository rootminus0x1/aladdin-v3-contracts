...
datafile = "fx.CRxbalance+liquidate-BoostableRebalancePool__StETHAndxETHWrapper.gnuplot.csv"
# additional imformation and error in fx.CRxbalance+liquidate-BoostableRebalancePool__StETHAndxETHWrapper.error.csv
set datafile separator comma
set key autotitle columnheader noenhanced
set key bmargin
set key title " "
# set terminal pngcairo
# set output "fx.CRxbalance+liquidate-BoostableRebalancePool__StETHAndxETHWrapper.gnuplot.png"
set terminal svg enhanced size 800 756.5 background rgb "gray90"
set autoscale
set colorsequence default
# set output "fx.CRxbalance+liquidate-BoostableRebalancePool__StETHAndxETHWrapper.gnuplot.svg"
set xrange reverse
