set title "CRxbalance+liquidate-FxUSDShareableRebalancePool__wstETH_FXN_xstETH" noenhanced
datafile = "fxUSD-wstETH.CRxbalance+liquidate-FxUSDShareableRebalancePool__wstETH_FXN_xstETH.gnuplot.csv"
# additional imformation and error in fxUSD-wstETH.CRxbalance+liquidate-FxUSDShareableRebalancePool__wstETH_FXN_xstETH.error.csv
set datafile separator comma
set key autotitle columnheader noenhanced
set key bmargin
set key title " "
# set terminal pngcairo
# set output "fxUSD-wstETH.CRxbalance+liquidate-FxUSDShareableRebalancePool__wstETH_FXN_xstETH.gnuplot.png"
set terminal svg enhanced size 800 718.5 background rgb "gray90"
set autoscale
set colorsequence default
# set output "fxUSD-wstETH.CRxbalance+liquidate-FxUSDShareableRebalancePool__wstETH_FXN_xstETH.gnuplot.svg"
set xrange reverse
...
plot datafile using ($2):($4) with lines linetype 2 linewidth 2 dashtype 2,\
     ...
     datafile using ($2):($11 == 0 ? 1/0 : $11) with linespoints linetype 1 pointtype 2 axes x1y2,\
     datafile using ($2):($12) with linespoints linetype 8 pointtype 1 axes x1y2,\
     datafile using ($2):($13) with linespoints linetype 8 pointtype 2 axes x1y2
